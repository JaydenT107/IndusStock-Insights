...
def second_part():
    ...
    with col1:
        ...
        date_format_copy = date_format.copy()
        date_format_2 = st.segmented_control('**Select Time Period**', date_list[date_list.index(date_format_copy)::], selection_mode = 'single', default = date_list[date_list.index(date_format_copy)+1])
