...
def scatter_plot(data,name,sday,eday,date_format,new_title=None):
    ...
    fig.add_hline(y = average_period, line_dash = 'dash', line_color = avg_line_color, name = 'Avg Volume: 3 Months', showlegend = True)
    ...
    width = 600,
    height = 400,
     legend=dict( x=0.02,  y=0.98, title = None, borderwidth = 0.3, font = dict(size = 3))
)
