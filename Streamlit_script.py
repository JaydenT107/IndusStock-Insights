...
def second_part(s3 = s3client):
    ...
    with col2:
        st.markdown(f"<h1 style='font-size: 45px; color:#fffd7b ;'> </h1>", unsafe_allow_html=True)
        st.markdown(f"<h1 style='font-size: 30px; color: white;'> <span style='color: yellow;'> </span></h1>", unsafe_allow_html=True)
