...
def second_part(s3 = s3client, sector = sector):
    ...
    with col1:
        ...
        st.markdown(f"<h1 style='font-size: 20px; color:white;'>"
            f"<span style='color: yellow;'>{volume_description[0]}</span> "
            f"stock average volatility over the past month: "
            f"<span style='color: yellow;'>{volume_description[-1]}</span></h1>", 
    ...
    with col2:
        ...
        st.markdown(f"<h1 style='font-size: 20px; color:white;'>"
            f"<span style='color: yellow;'>{volatility_description[0]}</span> "
            f"stock average volatility over the past month: "
            f"<span style='color: yellow;'>{volatility_description[-1]}</span></h1>", 
            unsafe_allow_html=True)
second_part()